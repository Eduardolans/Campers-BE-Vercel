...
exports.MercadoPagoModule = MercadoPagoModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [mercado_pago_service_1.MercadoPagoService, prisma_service_1.PrismaService, reservations_service_1.ReservationsService, camping_gateway_1.CampingGateway, payment_repository_1.PaymentRepository],
    })
], MercadoPagoModule);
