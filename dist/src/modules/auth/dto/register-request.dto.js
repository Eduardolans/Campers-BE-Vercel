...
class UserCreateDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, email: { required: true, type: () => String, format: "email" }, password: { required: true, type: () => String, minLength: 6 }, owner: { required: true, type: () => Boolean } };
    }
}
...
__decorate([
    ...
    (0, is_sanitizated_html_decorator_1.IsSanitizedHtml)(),
...
], UserCreateDto.prototype, "owner", void 0);
